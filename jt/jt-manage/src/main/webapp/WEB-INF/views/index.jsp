    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		<span>商品管理</span>
         		<ul>
         			<!--easyUI通过url /page/item-add 内部解析发起ajax请求 -->
         	...
         	<li>
         	    <span>商品管理</span>
         	    <ul>
         	  	<li data-options="attributes:{'url':'/page/order'}">订单管理</li>
	         		<li data-options="attributes:{'url':'/page/order-item'}">商品管理</li>
	         		<li data-options="attributes:{'url':'/page/order-shipping'}">订单单据</li>
         	    </ul>
         	</li>
         	<li>
         	    <span>会员管理</span>
         	    <ul>
         	  	<li data-options="attributes:{'url':'/page/tb-user'}">会员管理</li>
         	    </ul>
